    ...
    def get(self, request):
        ...
        return Response(
            api_response(True, "Dashboard stats fetched", {
                ...
                "scheduled_today":    Appointment.objects.filter(date_time__date=today, status="scheduled").count(),
                "completed_today":    Appointment.objects.filter(date_time__date=today, status="completed").count(),
